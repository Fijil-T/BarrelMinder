...
clientname="SmartBrewhub"+str(r) # החלפנו את השם של הקליינט
DHT_topic = 'pr/BarrelMinder/5976397/sts' 
update_rate = 5000
weight_,cups_ = 1000,80 
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        formLayot.addRow("Pints",self.Cups)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('BarrelMinder')        
